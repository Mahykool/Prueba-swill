...
const {
  readMods,
  saveMods,
  appendLog: appendModLog,
  toNum: toNumMods,
  jidFull: jidFullMods
} = require('./mods-utils.js')

const { ROLES } = require('./roles-config.js')
...
// ------------------------------------------------------------
// ✅ Integración con roles-config.js
// ------------------------------------------------------------
const getUserRole = (jid) => {
  if (!jid) return 'user'
...
module.exports = {
  ...
  getUserRole, getRoleInfo, roleHasPermission
}
